...
import Android_Decay_Animation from '@/posts/Android_Decay_Animation' 
...
export default new Router({
  routes: [
    ...
    ,{path: '/Android_Decay_Animation',name: 'Article13',component: Android_Decay_Animation,meta: {keepAlive: true}} 
  ]
})
