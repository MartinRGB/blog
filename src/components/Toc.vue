<template>
      <div id="toc" class="float-toc">
        <div class="toc-content">
          ...
          <p v-if="this.tocData != null" class="toc-title">{{this.object.title}}</p>
          <p v-else class="toc-title">{{this.contentTitle}}</p>
          ...
          <slot>
            <ul v-if="this.tocData != null" id="v-for-object" class="TableOfContents">
...
<script>
  ...
  export default {
    name: 'toc',
    props:['tocData','tocTitle'],
    data: function () {return {
      
        object: this.tocData,
        contentTitle:this.tocTitle
      }
    },
    methods: {
