...
<p><img data-action="zoom" src="../static/images/vulkan/02/vulkan_sdk_download_buttons.png" alt=""></p>
<p>安装时要注意 SDK 的安装地址。我们还要检查下显卡和驱动是否支持 Vulkan。进入安装 SDK 的目录，打开 <strong>Bin32</strong> 目录，运行 <strong>cube.exe</strong>。效果如下</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/cube_demo.png" alt=""></p>
...
<p><img data-action="zoom" class="smallimg" src="../static/images/vulkan/02/glfw_directory.png" alt=""></p>
...
<p><img data-action="zoom" class="smallimg" src="../static/images/vulkan/02/library_directory.png" alt=""></p>
...
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_new_cpp_project.png" alt=""></p>
<p>点击 <strong>Next</strong>, 选择 <strong>Console application</strong> 作为应用类型，确保勾选 <strong>Empty project</strong>。</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_application_settings.png" alt=""></p>
<p>点击 <strong>Finish</strong> 创建项目，然后添加 C++ 文件。</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_new_item.png" alt=""></p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_new_source_file.png" alt=""></p>
...
<p><img data-action="zoom" class="mediumimg" src="../static/images/vulkan/02/vs_open_project_properties.png" alt=""></p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_all_configs.png" alt=""></p>
<p>选择 <strong>C++ -&gt; General -&gt; Additional Include Directories</strong> （附加包含目录）选择下拉的 <strong>&lt;Edit...&gt;</strong> （编辑）。</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_cpp_general.png" alt=""></p>
<p>添加 Vulkan，GLFW，GLM 的头文件目录:</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_include_dirs.png" alt=""></p>
<p>下一步, 链接器 -&gt; 附加库目录:</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_link_settings.png" alt=""></p>
<p>添加 Vulkan 和 GLFW 的库目录:</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_link_dirs.png" alt=""></p>
<p>选择 <strong>Linker -&gt; Input</strong> （连接器 -&gt; 输入） 编辑 <strong>Additional Dependencies</strong> （附加依赖项）。</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_link_input.png" alt=""></p>
<p>输入 Vulkan 和 GLFW 对象文件名。:</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_dependencies.png" alt=""></p>
<p>现在可以关闭属性对话框，如果一切正常，就不会有高亮报错</p>
<p>按 <strong>F5</strong> 编译运行项目，会看到如下命令弹窗:</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_test_window.png" alt=""></p>
...
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_export_template.png" alt=""></p>
<p>选择 <strong>Finish</strong> ，在新建项目 <strong>New Project</strong>
便有了模板，用它来创建一个 <strong>Hello Triangle</strong> 作为预习。</p>
<p><img data-action="zoom" src="../static/images/vulkan/02/vs_template.png" alt=""></p>
...
<img data-action="zoom" src="../static/images/vulkan/02/mac_cmake_vulkansamples.png" alt="">
...
<ul>
  ...
  <li>编译运行，结果如下：</li>
  <img data-action="zoom" src="../static/images/vulkan/02/mac_android_loadvulkan.jpg" alt="">
</ul>
...
<ul>
  ...
  <li><img data-action="zoom" src="../static/images/vulkan/02/macos_lunarg_test.png" alt=""></li>
</ul>
...
<img data-action="zoom" src="../static/images/vulkan/02/mac_cocoa_app.png" alt="">
<p>在 <strong>Project</strong> 中搜索 <strong>Serach Path</strong>，添加头文件和库文件的搜索路径：</p>
<img data-action="zoom" src="../static/images/vulkan/02/mac_linked_libraried.png" alt="">
<p>当然你也可以在 <strong>Preference -> Location -> Custom Paths</strong> 中，设置系统默认库位置</p>
<img data-action="zoom" src="../static/images/vulkan/02/mac_custom_location.png" alt="">
...
<img data-action="zoom" src="../static/images/vulkan/02/mac_glfw_test.png" alt="">
...
<img data-action="zoom" src="../static/images/vulkan/02/mac_vulkan_framework.png" alt="">
<p>在 Project 的 Build Setting 搜索 <strong>Other Linker Flags</strong>，填写-lgfw3</p>
<img data-action="zoom" src="../static/images/vulkan/02/Other_Linker_Flags.png" alt="">
...
<img data-action="zoom" src="../static/images/vulkan/02/mac_vulakn_final1.png" alt="">
